...
@SourceType(value = "SlackARP", label = "Slack",uiConfig = "slack-layout.json")
public class SlackConf extends AbstractArpConf<SlackConf> {
  private static final String ARP_FILENAME = "arp/implementation/slack-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.slack.SlackDriver";
